...
class riwayatjabatan 
{
    ...
    {
        $data = $this->db->table('riwayatjabatan')->get()->resultArray();
        $res = '<a href="?target=riwayatjabatan&act=tambah_riwayatjabatan" class="btn btn-info btn-sm">Tambah riwayatjabatan</a><br><br>
        ...
        <table class="table table-striped">
            ...
            foreach ($data as $r) {
                ...
                <td width="10">'.$r['jk'].'</td>
                <td width="150">
                    <a href="?target=riwayatjabatan&act=edit_riwayatjabatan&id='.$r['id_pegawai'].'" class="btn btn-dark btn-sm">Edit</a>
                    <a href="?target=riwayatjabatan&act=delete_riwayatjabatan&id='.$r['id_pegawai'].'" class="btn btn-danger btn-sm">Hapus</a>
                </td>';
                $no++;
            }
        return $res; 
    ...
    {
        $res = '<a href="?target=riwayatjabatan" class="btn btn-danger btn-sm">Kembali</a><br><br>';
        $res .= '<form method="post" action="?target=riwayatjabatan&act=simpan_riwayatjabatan">
            <div class="mb-3">
    ...
    public function simpan(){
        ...
        return $this->db->table('riwayatjabatan')->insert($data);
    }
    public function edit($id)
    {
        // get data riwayatjabatan
        $r = $this->db->table('riwayatjabatan')->where("id_pegawai='$id'")->get()->rowArray();
        //cek radio

        $res = '<a href="?target=riwayatjabatan" class="btn btn-danger btn-sm">kembali</a><br>';
        $res .= '<form method="post" action="?target=riwayatjabatan&act=update_riwayatjabatan">
    ...
    public function update()
    {
        ...
        return $this->db->table('riwayatjabatan')->where("id_pegawai='$param'")->update($data);
    }

    public function delete($id)
    {
        return $this->db->table('riwayatjabatan')->where("id_pegawai='$id'")->delete();
    }
}