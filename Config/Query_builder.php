...
class Query_builder implements Query
{
    ...
    public function get()
    {
        ...
        $this->v_query .= " FROM " . $this->v_table . " "; // select npm, nama from pegawai

        if (!empty($this->v_join)) {
            $this->v_query .= $this->v_join . " ";
        }

        if (!empty($this->v_wheree)) {
            $this->v_query .= $this->v_where . " ";
        }

        if (!empty($this->v_order_by)) {
            $this->v_query .= $this->v_order_by . " "; // select * from pegawai where order_by npm asc/ desc
        }
